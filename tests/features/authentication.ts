...
Given(`a verified user exists with:`, (arg0: DataTable) => {
    // [Given] Sets up the initial state of the system.
...
When(`I attempt login with wrong password {string} {float} attempt {int}`, (arg0: string, arg1: number, arg2: number) => {
    // [When] Describes the action or event that triggers the scenario.
});
...
Given(`my refresh token has also expired \(> {int} days)`, (arg0: number) => {
    // [Given] Sets up the initial state of the system.
});
...
Given(`I have been inactive for {int} minutes \(no page navigation, no mouse\/keyboard activity)`, (arg0: number) => {
    // [Given] Sets up the initial state of the system.
});
...
Then(`I should see a list of all active sessions including:`, (arg0: DataTable) => {
    // [Then] Describes the expected outcome or result of the scenario.
    // <DataTable> argument is detected:
    // - With column headers: use DataTable.rowsHash(), which outputs an object containing key-value pairs for each row (e.g. { key1: value, key2: value }).
    // - With row headers: use DataTable.hashes(), which outputs an array of objects (e.g. [{ key1: value, key2: value }]).
...
When(`I enter the {int}-digit code {string}`, (arg0: number, arg1: string) => {
    // [When] Describes the action or event that triggers the scenario.
});
...
When(`I attempt to enter the code incorrectly {int} times:`, (arg0: number) => {
    // [When] Describes the action or event that triggers the scenario.
});
...
Given(`verification link has expired \(> {int} hours)`, (arg0: number) => {
    // [Given] Sets up the initial state of the system.
});
...
Then(`the new link\/code should be valid for another {int} hours\/{int} minutes`, (arg0: number, arg1: number) => {
    // [Then] Describes the expected outcome or result of the scenario.
});
...
When(`I attempt to resend verification email {int} times within {int} hour:`, (arg0: number, arg1: number) => {
    // [When] Describes the action or event that triggers the scenario.
});
...
Then(`the system should display a requirements checklist:`, (arg0: DataTable) => {
    // [Then] Describes the expected outcome or result of the scenario.
    // <DataTable> argument is detected:
    // - With column headers: use DataTable.rowsHash(), which outputs an object containing key-value pairs for each row (e.g. { key1: value, key2: value }).
    // - With row headers: use DataTable.hashes(), which outputs an array of objects (e.g. [{ key1: value, key2: value }]).
...
Given(`the password is hidden with dots\/asterisks`, () => {
    // [Given] Sets up the initial state of the system.
});
...
Then(`an activity log entry should be created with:`, (arg0: DataTable) => {
    // [Then] Describes the expected outcome or result of the scenario.
    // <DataTable> argument is detected:
    // - With column headers: use DataTable.rowsHash(), which outputs an object containing key-value pairs for each row (e.g. { key1: value, key2: value }).
    // - With row headers: use DataTable.hashes(), which outputs an array of objects (e.g. [{ key1: value, key2: value }]).
...
Then(`I should be able to filter by:`, (arg0: DataTable) => {
    // [Then] Describes the expected outcome or result of the scenario.
    // <DataTable> argument is detected:
    // - With column headers: use DataTable.rowsHash(), which outputs an object containing key-value pairs for each row (e.g. { key1: value, key2: value }).
    // - With row headers: use DataTable.hashes(), which outputs an array of objects (e.g. [{ key1: value, key2: value }]).
